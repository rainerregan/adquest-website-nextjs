...
const CounterSection = () => {
  return (
    <div className='absolute translate-y-[50%] right-0 left-0 bottom-0 w-full max-w-7xl mx-auto px-[24px] lg:px-[48px]'>
      <div className=' bg-main-black px-4 lg:px-12 py-4 lg:py-8 rounded-xl lg:rounded-[25px] text-white flex flex-col justify-center items-center'>
        <h2 className='text-center mb-2 lg:mb-4 text-base md:text-2xl lg:text-3xl xl:text-4xl text-balance'>Total Hadiah Uang Tunai Diberikan Hingga Saat Ini</h2>
        <div className='flex gap-1 md:gap-4 xl:gap-8 items-center w-fit mb-2'>
